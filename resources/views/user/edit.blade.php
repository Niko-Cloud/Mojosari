            ...
            <form action="{{ route('user.update', $user->id)  }}" method="POST" enctype="multipart/form-data">
                ...
                @enderror
                 <div class="form-group">
                    ...
                    <input type="email" class="form-control" name="name" placeholder="Email" value="{{$user->email}}">{{$user->email}}
                </div>
                 @error('email')
                <small style="color:red">{{$message}}</small>
                @enderror
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" name="name" placeholder="Nama" value="{{$user->password}}">
                </div>
                 @error('password')
                <small style="color:red">{{$message}}</small>
                @enderror
